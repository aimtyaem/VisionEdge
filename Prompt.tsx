...
export function Prompt() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      // Fix: Remove "models/" prefix from model name as per coding guidelines.
      ...
      // Fix: Get the full response object to access `.text` property, and use the recommended `contents` structure.
      ...
      // Fix: Add robust error handling for JSON parsing and API calls.
      try {
        ...
        alert(
          `The model returned a response that could not be processed. Please try again.\n\nResponse:\n${response}`,
        );
      ...
      alert(
        'An error occurred while communicating with the model. Please check the console for details.',
      );
    } finally {
      setIsLoading(false);
    }
